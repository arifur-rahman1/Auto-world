...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <div className="absolute flex items-center transform bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] w-full h-full">
        <div className='text-white space-y-7 pl-5 w-1/3'>
